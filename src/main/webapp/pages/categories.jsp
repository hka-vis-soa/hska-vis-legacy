            ...
            <s:iterator value="categories" status="rowstatus">
                <tr>
                    <s:if test="#rowstatus.odd == true">
                        ...
                        <td class="odd"><a
                                href="<s:url action="DeleteCategoryAction"><s:param name="catId" value="id" /></s:url>"><img
                    ...
                    <s:else>
                        ...
                        <td>
                            <a href="<s:url action="DeleteCategoryAction"><s:param name="catId" value="id" /></s:url>"><img
                                    src="img/delBtn.png" alt="<s:text name="product.delete" />"/></a></td>
                    </s:else>
                </tr>
            </s:iterator>
