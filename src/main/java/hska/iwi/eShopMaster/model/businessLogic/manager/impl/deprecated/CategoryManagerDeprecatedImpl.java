package hska.iwi.eShopMaster.model.businessLogic.manager.impl.deprecated;
...
public class CategoryManagerDeprecatedImpl implements CategoryManager {
    private CategoryDAO helper;

    public CategoryManagerDeprecatedImpl() {
